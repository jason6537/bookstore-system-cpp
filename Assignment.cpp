...
void mpBookstoreMenu(vector<Book>& book1) //mp's menu
{
	int option = 1;
	do {
...
void mpsBooksMonth(vector<Book>& book2) //mp's books of the month
{
	int selected_books[10] = {};	//initialize selected_books array to 0
	int num_selected_books = 0;
	int option = 1;
...
void sunnysBooksMonth(vector<Book>& book3) //sunny's books of the month
{
	int selected_books[10] = {};	//initialize selected_books array to 0
	int num_selected_books = 0;
	int option = 1;
